...
```
```
export PKG_CONFIG_PATH=/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/lib/pkgconfig/:$PKG_CONFIG_PATH
exprot PATH=/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/lib/pkgconfig/:$PATH
Sys.setenv(XML_CONFIG="/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/bin/xml2-config")
Sys.setenv(PKG_CONFIG_PATH="/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/lib/pkgconfig/")
```
找资料
http://blog.sciencenet.cn/blog-773206-1155793.html
https://blog.51cto.com/u_3078781/3291654
```
wget -c https://cran.r-project.org/src/contrib/Archive/xml2/xml2_1.3.2.tar.gz
#R CMD INSTALL --configure-vars='LIB_DIR=/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/lib/pkgconfig/' <curl-file.gz>
...
最后成功了
```
../R-3.6.3/bin/R CMD INSTALL --configure-vars='INCLUDE_DIR=/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/include/libxml2/ LIB_DIR=/public/frasergen/MED/software/R/R_dependency/libxml2-2.9.1/lib/' xml2_1.3.2.tar.gz

```


## /usr/bin/aclocal: Perl lib version (5.28.2) doesn't match executable '/usr/bin/perl' version (5.16.3) at /public/frasergen/MED/software/zhangbo/PERL/perl-5.28.2/lib/Config.pm line 62.
...
### 更换镜像
```
https://cran.microsoft.com/src/contrib/Archive/


install.packages("bitops", repos = "http://mirrors.ustc.edu.cn/CRAN/")
```
...
library(ggplot2, lib.loc = 'path_to_library_with_ggplot_0.9.1')
...
#  unable to load shared object 'RCurl.so':  libiconv.so.2: cannot open shared object file: No such file or directory
